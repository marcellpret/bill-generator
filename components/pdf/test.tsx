...
=======
                <View>
                    <Text>Mit freundlichen Grüßen,</Text>
                    <Image
                        src="https://gdnumfwcwysjtibwfoke.supabase.co/storage/v1/object/sign/invoices-bucket/dafec758-f11e-4952-83da-a3979b643fa2/assinatura.jpg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJpbnZvaWNlcy1idWNrZXQvZGFmZWM3NTgtZjExZS00OTUyLTgzZGEtYTM5NzliNjQzZmEyL2Fzc2luYXR1cmEuanBnIiwiaWF0IjoxNzQxMDQ2MjQzLCJleHAiOjE3NzI1ODIyNDN9.nGmc-Nuq14RAaeYBb7Dzm9o-TPOACJqM49PiIoOjIiI"
                        style={{ width: "40%" }}
                    />
                </View>
                <View
                ...
                >
                    <View style={small_italic}>
                        ...
                        <Text>IBAN:</Text>
                        <Text>BIC:</Text>
>>>>>>> f8c6215 (reconnecting to supabase)
                    </View>
                    <View
                        style={[
                            row,
